...
2. Then rename the .env.example file to ".env" and change values as per your need

3. Finally run the application in development using below command -
